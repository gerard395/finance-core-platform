...
final class SalesPostingConfigurationLinkageTest extends TestCase
{
    ...
    private function seedTenant(string $administration, int $tenant): void
    {
        ...
        for ($sequence = 1; $sequence <= 2; $sequence++) {
            ...
            DB::table('open_items')->insert(['id' => $this->openItemId($tenant, $sequence), 'administration_id' => $administration, 'relation_id' => $this->relationId($tenant), 'journal_entry_id' => $this->entryId($tenant, $sequence), 'open_item_type' => 'receivable', 'original_amount' => '121', 'currency' => 'EUR', 'opened_on' => '2026-08-24', 'created_at' => $now, 'updated_at' => $now]);
        }
    }
