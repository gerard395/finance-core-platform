...
final class EloquentOrderInvoicingFactsTest extends TestCase
{
    ...
    private function seedTenant(string $admin, string $code): void
    {
        ...
        DB::table('tax_codes')->insert(['id' => $this->tax($admin), 'administration_id' => $admin, 'code' => 'T'.$code, 'name' => 'Tax '.$code, 'rate' => '21', 'direction' => 'output', 'status' => 'active', 'created_at' => $now, 'updated_at' => $now]);
