...
final class JournalIdTest extends TestCase
{
    public function test_it_wraps_a_uuid_and_uses_value_object_semantics(): void
    {
        ...
        $id = new JournalId($uuid);

        self::assertSame($uuid, $id->uuid());
        self::assertTrue($id->equals(new JournalId(new Uuid($uuid->toString()))));
        self::assertFalse($id->equals(new JournalId(new Uuid('123e4567-e89b-42d3-a456-426614174000'))));
