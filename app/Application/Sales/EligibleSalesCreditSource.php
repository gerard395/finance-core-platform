...
final readonly class EligibleSalesCreditSource
{
    public function __construct(private SalesInvoiceId $id, private SalesInvoiceNumber $number, private CustomerNumber $customerNumber, private DisplayName $customerName, private DateTimeImmutable $invoiceDate, private SalesInvoiceStatus $status, private Currency $currency, private Money $netTotal, private Money $taxTotal, private Money $grossTotal) {}
