...
final readonly class PostSalesInvoiceResult
{
    /** @param list<TaxPostingId> $taxPostingIds */
    private function __construct(
        private PostSalesInvoiceStatus $status,
    ...
    {
        return new self(PostSalesInvoiceStatus::Success, $journalEntryId, $openItemId, array_values($taxPostingIds));
    }

    public static function forStatus(PostSalesInvoiceStatus $status): self
    {
        return new self($status);
    }

    public function status(): PostSalesInvoiceStatus
    {
        return $this->status;
    }
