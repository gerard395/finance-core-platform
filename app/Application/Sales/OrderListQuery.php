...
final readonly class OrderListQuery
{
    ...
    public function __construct(
        ...
        private OrderSortField $sortField = OrderSortField::OrderDate,
        private OrderSortDirection $sortDirection = OrderSortDirection::Descending,
        private int $page = 1,
        private int $perPage = 25,
    ) {
        if ($page < 1 || ! in_array($perPage, [25, 50, 100], true) || ($dateFrom !== null && $dateTo !== null && $dateTo < $dateFrom)) {
            throw new InvalidArgumentException('Invalid Order list query.');
        }
    ...
    public function sortField(): OrderSortField
    {
        return $this->sortField;
    }

    public function sortDirection(): OrderSortDirection
    {
