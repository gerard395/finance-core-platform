...
final readonly class ReopenAccountingPeriod
{
    ...
    {
        return $this->transactions->run(fn () => AccountingPeriodMutationStatus::from($this->years->transition($a, $id, $reason, $actor, $at, true)->value));
    }
}
