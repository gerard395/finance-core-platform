...
final readonly class EnsureAdministrationPermission
{
    ...
    public function handle(Request $request, Closure $next, string $permissionCode): Response
    {
        ...
        try {
            $permission = AdministrationPermission::from($permissionCode);
        } catch (ValueError) {
    ...
    public static function using(AdministrationPermission $permission): string
    {
